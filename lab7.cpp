...
void generate_typeNV_Nroute(int** mass, int count) { //невзвешенный неориентированный
...
void generate_typeV_Nroute(int** mass, int count) { // взвешенный неориентированный
...
void generate_typeNV_route(int** mass, int count) { //невзвешенный ориентированный
	int a;
	int b;
	for (int i = 0; i < count; i++) {
		for (int j = 0; j < count; j++) {
...
void generate_typeV_route(int** mass, int count) { //взвешенный ориентированный
...
int main(int argc, char* argv[])
{
	...
	if (argc < 2) {
		...
		printf("Взвешенный граф - typev.\n");
		printf("Невзвешенный граф - typenv.\n");
